...
![Version: 3.0.0-beta.4](https://img.shields.io/badge/Version-3.0.0--beta.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.0.0-beta](https://img.shields.io/badge/AppVersion-3.0.0--beta-informational?style=flat-square)
...
| ui.image.tag | string | `"2.0.0-beta.5"` | Image tag Defaults to `Chart.AppVersion` if omitted |
