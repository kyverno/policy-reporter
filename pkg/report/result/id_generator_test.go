...
func TestCustomGenerator(t *testing.T) {
	...
	t.Run("ID From Namespace", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{ObjectMeta: v1.ObjectMeta{Namespace: "test"}}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Description: ""}})
	...
	t.Run("ID From Policy", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Policy: "test"}})
	...
	t.Run("ID From Rule", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Rule: "test"}})
	...
	t.Run("ID From Result", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Result: "fail"}})
	...
	t.Run("ID From Category", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Category: "test"}})
	...
	t.Run("ID From Message", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Description: "test"}})
	...
	t.Run("ID From Created", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Timestamp: v1.Timestamp{Seconds: 1714641964}}})
	...
	t.Run("ID From Property", func(t *testing.T) {
		...
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{ReportResult: v1alpha1.ReportResult{Properties: map[string]string{"id": "1234"}}})
	...
	t.Run("ID From Label", func(t *testing.T) {
		...
		empty := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{})
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{ObjectMeta: v1.ObjectMeta{Labels: map[string]string{"id": "1234"}}}}, openreports.ResultAdapter{})
	...
	t.Run("ID From Annotation", func(t *testing.T) {
		...
		empty := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{}}, openreports.ResultAdapter{})
		id := generator.Generate(&openreports.ReportAdapter{Report: &v1alpha1.Report{ObjectMeta: v1.ObjectMeta{Annotations: map[string]string{"id": "1234"}}}}, openreports.ResultAdapter{})
