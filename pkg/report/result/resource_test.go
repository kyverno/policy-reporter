...
func TestResource(t *testing.T) {
	t.Run("resource from scope", func(t *testing.T) {
		...
		res := result.Resource(&v1alpha1.Report{Scope: resource}, *openreports.ORResultAdapter{})
	...
	t.Run("resource from result", func(t *testing.T) {
		...
		res := result.Resource(&v1alpha1.Report{}, *openreports.ORResultAdapter{Subjects: []corev1.ObjectReference{*resource}})
	...
	t.Run("empty fallback resource", func(t *testing.T) {
		res := result.Resource(&v1alpha1.Report{}, *openreports.ORResultAdapter{Subjects: []corev1.ObjectReference{}})
