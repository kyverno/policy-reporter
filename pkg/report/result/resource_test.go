...
func TestResource(t *testing.T) {
	t.Run("resource from scope", func(t *testing.T) {
		...
		res := result.Resource(&v1alpha1.Report{Scope: resource}, v1alpha1.ReportResult{})
	...
	t.Run("resource from result", func(t *testing.T) {
		...
		res := result.Resource(&v1alpha1.Report{}, v1alpha1.ReportResult{Subjects: []corev1.ObjectReference{*resource}})
	...
	t.Run("empty fallback resource", func(t *testing.T) {
		res := result.Resource(&v1alpha1.Report{}, v1alpha1.ReportResult{Subjects: []corev1.ObjectReference{}})
