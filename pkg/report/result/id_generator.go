...
type FieldMapperFunc = func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64

type IDGenerator interface {
	Generate(polr openreports.ReportInterface, res openreports.ResultAdapter) string
}

var fieldMapper = map[string]FieldMapperFunc{
	"resource": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
	...
	"namespace": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, polr.GetNamespace())
	},
	"policy": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, res.Policy)
	},
	"rule": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, res.Rule)
	},
	"result": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, string(res.Result))
	},
	"category": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, res.Category)
	},
	"message": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
		return fnv1a.AddString64(h1, res.Description)
	},
	"created": func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
...
var (
	propertyResolver = func(field string) FieldMapperFunc {
		...
		return func(h1 uint64, polr openreports.ReportInterface, res openreports.ResultAdapter) uint64 {
...
func (g *customIDGenerator) Generate(polr openreports.ReportInterface, res openreports.ResultAdapter) string {
...
func (g *defaultIDGenerator) Generate(polr openreports.ReportInterface, res openreports.ResultAdapter) string {
	if id, ok := res.Properties[v1alpha2.ResultIDKey]; ok {
		return id
	}
