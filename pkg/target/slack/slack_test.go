...
func Test_SlackTarget(t *testing.T) {
	...
	t.Run("Send enforce Result", func(t *testing.T) {
		...
		client.Send(&payload.PolicyReportResultPayload{Result: fixtures.EnforceTargetSendResult})
	})
	...
	t.Run("Send incomplete Result", func(t *testing.T) {
		...
		client.Send(&payload.PolicyReportResultPayload{Result: fixtures.MissingUIDSendResult})
	})
	...
	t.Run("Send incomplete Result2", func(t *testing.T) {
		...
		client.Send(&payload.PolicyReportResultPayload{Result: fixtures.MissingAPIVersionSendResult})
	})
