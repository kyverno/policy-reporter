...
var CompleteTargetSendResult = openreports.ResultAdapter{
...
var MinimalTargetSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
...
var EnforceTargetSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: requests and limits required. Rule autogen-check-for-requests-and-limits failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "require-requests-and-limits-required",
...
var MissingUIDSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: requests and limits required. Rule autogen-check-for-requests-and-limits failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "require-requests-and-limits-required",
		Rule:        "check-for-requests-and-limits",
...
var MissingAPIVersionSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: requests and limits required. Rule autogen-check-for-requests-and-limits failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "require-requests-and-limits-required",
		Rule:        "check-for-requests-and-limits",
...
var ErrorSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: label required. Rule app-label-required failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "app-label-requirement",
		Result:      v1alpha2.StatusFail,
...
var CritcalSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: label required. Rule app-label-required failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "app-label-requirement",
		Result:      v1alpha2.StatusFail,
...
var InfoSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: label required. Rule app-label-required failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "app-label-requirement",
		Result:      v1alpha2.StatusFail,
...
var DebugSendResult = openreports.ResultAdapter{
	ReportResult: v1alpha1.ReportResult{
		Description: "validation error: label required. Rule app-label-required failed at path /spec/template/spec/containers/0/resources/requests/",
		Policy:      "app-label-requirement",
		Result:      v1alpha2.StatusFail,
