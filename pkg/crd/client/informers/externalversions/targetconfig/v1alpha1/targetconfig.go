...
type TargetConfigInformer interface {
	...
	Lister() targetconfigv1alpha1.TargetConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyreporterV1alpha1().TargetConfigs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyreporterV1alpha1().TargetConfigs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyreporterV1alpha1().TargetConfigs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyreporterV1alpha1().TargetConfigs(namespace).Watch(ctx, options)
			},
		}, client),
		&apitargetconfigv1alpha1.TargetConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *targetConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apitargetconfigv1alpha1.TargetConfig{}, f.defaultInformer)
}

func (f *targetConfigInformer) Lister() targetconfigv1alpha1.TargetConfigLister {
	return targetconfigv1alpha1.NewTargetConfigLister(f.Informer().GetIndexer())
}
